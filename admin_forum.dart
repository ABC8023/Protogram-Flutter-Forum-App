...
import 'admin_forum_approved.dart';
import 'admin_forum_pending.dart';
import 'admin_forum_rejected.dart';

/// Landing page that shows two big buttons (“Approved / Pending”)
class AdminForumApproval extends StatefulWidget {
  const AdminForumApproval({super.key});
  @override
  State<AdminForumApproval> createState() => _AdminForumApprovalState();
}

class _AdminForumApprovalState extends State<AdminForumApproval> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Forum Approval'),
                ...
                Column(
                  children: [
                    _bigButton(
                      ...
                      height: _half,
                      onTap: () => Get.to(() => const AdminForumApproved()),
                    ),
                    ...
                    _bigButton(
                      ...
                      icon: Icons.cancel,
                      height: _half,
                      onTap: () => Get.to(() => const AdminForumRejected()),
                    ),
                  ],
                ),
                ...
                Stack(
                  ...
                  children: [
                    _bigButton(
                      ...
                      onTap: () => Get.to(() => const AdminForumPending()),
                    ),
                    if (_hasPending)
                      const Positioned(
